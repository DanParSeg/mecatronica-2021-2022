...
module main #(
 ...
 parameter v96af80 = 16000,
 parameter v32627b = 20000,
 parameter v3b75fc = 20000,
 parameter v405a09 = 16000
) (
 input v6b7e53,
 input v5961a8,
 input v269f01,
 ...
 localparam p29 = v96af80;
 localparam p30 = v32627b;
 localparam p31 = v3b75fc;
 localparam p32 = v405a09;
 wire w1;
 wire w2;
 wire w3;
 wire w4;
...
/*-- Valor_255_8bits  */
/*-- - - - - - - - - - - - - - - - - - - - - - - --*/
/*-- Valor constante 255 para bus de 8 bits
/*-------------------------------------------------*/
//---- Top entity
module v5e3669 #(
 parameter v62c0b1 = "$",
